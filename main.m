...
sim.options.control.waypoints = trajectory_control.waypoints;
sim.options.control.waypoint_radius = trajectory_control.waypoint_radius;
sim.options.control.loop = trajectory_control.loop;
...
plot_results_control_summary(t, x, sim, SIM_DATA); %plot_results(t, x, sim, SIM_DATA); or plot_results_control_summary(t, x, sim, SIM_DATA);
