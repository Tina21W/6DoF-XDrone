function [properties,aerodynamics,initialization] = x_Drone()
    ...
    properties.hub_radius = 11e-3;  % [m]
    properties.hub_height = 0.03;   % [m]
    properties.no_blades = 3;
    properties.design_RPM = 1500; % [RPM]
    properties.design_speed = 15; % [m/s]
    properties.f_coeff = 7e-3; % Friction Torque Coefficient
    ...
    properties.Prop.radius = 55/2 *1e-3; 
